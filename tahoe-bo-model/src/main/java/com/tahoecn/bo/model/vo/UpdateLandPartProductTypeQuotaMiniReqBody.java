...
public class UpdateLandPartProductTypeQuotaMiniReqBody {
    ...
    private List<LandPartProductTypeMiniVO> landPartProductTypeList;
    ...
    public List<LandPartProductTypeMiniVO> getLandPartProductTypeList() {
        return landPartProductTypeList;
    }

    public void setLandPartProductTypeList(List<LandPartProductTypeMiniVO> landPartProductTypeList) {
