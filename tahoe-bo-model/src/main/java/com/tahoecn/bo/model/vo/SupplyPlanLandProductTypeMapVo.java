...
/**
 * @ClassName：SupplyPlanLandProductTypeMapVo
 * @Description：TODO(这里用一句话描述这个类的作用) 
 * @author liyongxu 
 * @date 2019年8月9日 下午4:27:23 
 * @version 1.0.0 
 */
@Data
public class SupplyPlanLandProductTypeMapVo{
    ...
    private List<SupplyPlanLandProductTypeDataVo> supplyPlanDataList;
